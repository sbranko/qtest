          ...
          if (state is Loading) {
            ...
            return NotificationListener<ScrollNotification>(
              onNotification: (scrollInfo) {
                ...
                if (context.read<MovieCubit>().shouldFetchMoreMovies(scrollInfo, 200)) {
                  context.read<MovieCubit>().fetchPopularMovies(state.currentPage + 1);
                }
                return false;
              },
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          child: MovieItem(movie: movie, page: state.currentPage,),
...
class MovieItem extends StatefulWidget {
  ...
  final int page;
   bool isFavorite;
   MovieItem({super.key, required this.movie, required this.page,  this.isFavorite = false, });
...
class _MovieItemState extends State<MovieItem> {
  ...
  builder: (context, state) {
    MovieBO? isFavorite = context.read<MovieCubit>().updatedMovie(widget.movie);
...
class CustomPageTransition {
  static Widget build(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child) {
    ...
    return SlideTransition(
      ...
      child: FadeTransition(opacity: animation, child: child), // Slide and Fade combination
    );
  }
}
