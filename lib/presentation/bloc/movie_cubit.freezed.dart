...
mixin _$MovieState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<MovieBO> movies, int currentPage, bool hasReachedMax)
        loaded,
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function()? initial,
    TResult Function()? loading,
    TResult Function(List<MovieBO> movies, int currentPage, bool hasReachedMax)?
        loaded,
    TResult Function(String message)? error,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<MovieBO> movies, int currentPage, bool hasReachedMax});
}
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl(
      final List<MovieBO> movies, this.currentPage, this.hasReachedMax)
      : _movies = movies;

  final List<MovieBO> _movies;
  @override
  List<MovieBO> get movies {
  ...
  @override
  String toString() {
    return 'MovieState.loaded(movies: $movies, currentPage: $currentPage, hasReachedMax: $hasReachedMax)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_movies), currentPage, hasReachedMax);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(movies, currentPage, hasReachedMax);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(movies, currentPage, hasReachedMax);
  }
...
abstract class Loaded implements MovieState {
  const factory Loaded(final List<MovieBO> movies, final int currentPage,
